...
The term "univariate time series" refers to a time series that consists of single (scalar) observations recorded sequentially over equal time increments. Some examples are monthly CO2 concentrations(https://itl.nist.gov/div898/handbook/pmc/section4/pmc4411.htm) and southern oscillations(https://itl.nist.gov/div898/handbook/pmc/section4/pmc4412.htm) to predict el nino effects.
